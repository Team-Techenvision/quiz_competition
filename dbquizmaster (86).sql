...
(88, 334, 1, 'Pratham Chavan', '416012', '8698066925', 'be6148685373df5bcc6f0baffda23be3', 'pratham@gmail.com', 'Vinay', '2014-02-04', '', 6, 'rainbow school', 'kolhapur', '', 'Pratham Chavan', '9856321456', 1, 'kolhapur', 'kolhapur', 22, 'profile_image_334_1615187696.PNG', '2021-03-08 06:59:15');
...
--
ALTER TABLE `competition_uploadfile_submit`
  MODIFY `uploadfileid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `profile`
  MODIFY `profileid` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `user`
  MODIFY `user_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=335;

--
-- AUTO_INCREMENT for table `userprofile_master`
--
ALTER TABLE `userprofile_master`
  MODIFY `userprofileid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
