                ...
                <tbody>
                 ...
                 <!--    <a href=" < ?php echo base_url(); ?>User/competition_active/< ?php echo $list->competitionid; ?>/".&active=1>Active</a> -->
                   ...
                   <?php if($list->competitiontypeid==1){ ?>
                      ...
                      <a  id="" name="" href="<?php echo base_url(); ?>User/quizcompetition_list/<?php echo $list->competitionid; ?>" title="View Question" hidden> <img src="<?php echo base_url(); ?>assets/images/question.jpg"  width="35" height="32"></a>
                    <?php } ?>
                    </td>
                  <?php } ?>
                  </tr>
