        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-list"></i> List Area Information</h3>
              <div class="card-tools">
                <a href="add_pincode" class="btn btn-sm btn-block btn-primary">Add Area</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $list->countryname ?></td>
