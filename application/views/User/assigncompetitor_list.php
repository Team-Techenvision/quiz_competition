        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-list"></i> List Competitor Information</h3>
              <div class="card-tools">
                <a href="<?php echo base_url(); ?>User/add_assigncompetition" class="btn btn-sm btn-block btn-primary">Add Competitor</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tbody>
                  <?php $i = 0;
                  foreach ($assign_competition_list as $list) {
                    $i++; ?>
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $list->title ?></td>
                    <?php $u1 = $this->User_Model->get_U_name($list->user_id1); ?>

                    <td><?php echo $u1 ?></td>

                    <?php $u2 = $this->User_Model->get_U_name($list->user_id2); ?>
                    <td><?php echo $u2 ?></td>
