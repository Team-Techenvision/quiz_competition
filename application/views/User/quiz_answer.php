                    ...
                    <input type="hidden" name="queNo" value="<?php echo $queNo; ?>">
                        <!-- checkbox -->
                           <tr >  
                              ...
                              <input class="form-check-input" type="checkbox" value="1" name="correctans[]" id="flexCheckDefault">
