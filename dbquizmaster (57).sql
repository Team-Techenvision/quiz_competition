...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2021 at 02:51 PM
...
(11, 1, 0, 0, 2, 18, 99, '2020-12-29', 'second package', 'Register to see competition topic', '', 'Male(18+)', 4, 'photo_1610696124.jpg', 'aass', 0, 0, 'ddd', 0, 0, '', 0, '0', '2020-12-30 11:48:21'),
...
(59, 2, 1, 2, 1, 18, 99, '2021-03-10', 'Classical Singing', 'Register to see competition topic', '<p>Classical Singing</p>', '5', 5, 'photo_59_1612328773.jpg', '<ul><li>Participants should send their submissions based on the given topics. Submission should be in the desired format i.e video/ image. </li><li>Participants should send their submissions based on the given topics. Submission should be in the desir', 1000, 500, '<ul><li>Participants should send their submissions based on the given topics.\r\nSubmission should be in the desired format i.e video/ image.</li><li>Participants should send their submissions based on the given topics. Submission should be in the desired fo', 1, 0, '', 0, '', '2021-02-11 13:13:48'),
...
(53, 'Mahesh Velhal', '2021-02-18', 'Mahesh@gmail.com', '4', 'Kolhapur Highschool Kolhapur', 'qsads', 416012, 'Rohan Velhal', '8965578744', 1, 1, 1, 22, 12, 220, 2, '', '2021-02-12'),
...
(2, 220, 1, 'Rohan Velhal', '416012', '8484888489', 'Ki@1234556', 'Mahesh Velhal', '2021-02-18', 'Mahesh@gmail.com', 3, 'Kolhapur Highschool Kolhapur', 'qsads', '416012', 'Rohan Velhal', '8965578744', 1, 1, 1, 22, '', '2021-02-12 06:07:30'),
...
--
ALTER TABLE `competition`
  MODIFY `competitionid` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `profile`
  MODIFY `profileid` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `user`
  MODIFY `user_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=240;

--
-- AUTO_INCREMENT for table `userprofile_master`
--
ALTER TABLE `userprofile_master`
  MODIFY `userprofileid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `userquizsubmit`
--
ALTER TABLE `userquizsubmit`
  MODIFY `userquizsubmitid` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
